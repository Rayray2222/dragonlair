...
<body class="vh-100"
        ...
        <div class="container overflow-hidden">
            <div class="row gy-4 gy-md-5 gy-lg-0 align-items-center">
                ...
                <div class="col-12 col-lg-5">
                    <div class="row">
                        <div class="col-12 col-xl-11" style="background-color: rgba(0, 0, 0, 0.3);">
                            ...
                            <a href="index.php" class="btn bsb-btn-2xl btn-light rounded-pill">Explore Opportunities</a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card border-0 border-bottom border-light shadow-sm">
                                <div class="card-body text-center p-4 p-xxl-5">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor"
                                        class="bi bi-person-check text-light mb-4" viewBox="0 0 16 16">
                                        <path
                                    ...
                                    <a href="jobs_list_all.php" class="fw-bold text-decoration-none link-success">
                                        View Listings
    ...
    <!-- RESUME BUILDING STEP BY STEP MODAL -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="stepModalLabel">How to Build Resume</h5>
                ...
                <div class="modal-body">
                    ...
                    <div id="stepContainer">
                        ...
                        <div class="step" id="step1">
                            <h4>Step 1:Navigate</h4>
                            <p>Click the Login button right above the navigation</p>
                            <img src="img/login.png" alt="Create Alumni Account" class="img-fluid mb-3">
                            <p></p>
                        </div>
                        <!-- Step 2 -->
                        <div class="step" id="step2" style="display:none;">
                            <h4>Step 2:Create Acc as an Alumni</h4>

                            <img src="img/alumni.png" alt="Profile Information" class="img-fluid mb-3">
                            <p>Provide some information to complete your registration.</p>
                            <img src="img/a.png" alt="Profile Information" class="img-fluid mb-3">
                            <input type="text" class="form-control" placeholder="Enter information">
                        </div>
                        <!-- Step 3 -->
                        <div class="step" id="step3" style="display:none;">
                            <h4>Step 3: Go to Profile</h4>
                            <p></p>
                            <img src="images/step3_image.jpg" alt="Review CV" class="img-fluid mb-3">
                        </div>
                        <!-- Step 4 -->
                        <div class="step" id="step4" style="display:none;">
                            <h4>Step 4: Click CV </h4>
                            <p>Find the CV Button</p>
                            <img src="images/step4_image.jpg" alt="Generate CV" class="img-fluid mb-3">
                        </div>


                        <div class="step" id="step5" style="display:none;">
                            <h4>Step 5: Generate CV </h4>
                            <p>Confirm your details and generate your CV.</p>
                            <img src="images/step4_image.jpg" alt="Generate CV" class="img-fluid mb-3">
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="previousBtn" style="display:none;"
    ...
    <script>
        ...
        // Function to show/hide steps and update button visibility
        function changeStep(stepDirection) {
            ...
            // Show/hide Next/Previous buttons based on current step
            if (currentStep === 1) {
            ...
            if (currentStep === 5) {
                document.getElementById('nextBtn').style.display = 'none'; // Hide Next on the last step
            } else {
                document.getElementById('nextBtn').style.display = 'inline-block';
            }
        }

        // Initialize modal with the first step displayed
        document.addEventListener('DOMContentLoaded', () => {
            changeStep(0); // Start from the first step
        });
    </script>
