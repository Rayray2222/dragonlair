...
// Assuming candidate's ID is stored in session upon successful login
if (isset($_SESSION['can_id'])) {
    $loggedIn = true; // Candidate is logged in
    $candidate_id = $_SESSION['can_id']; // Get the candidate's ID
} else {
    $loggedIn = false; // Candidate is not logged in
}
?>
        ...
        <div class="inner-wrapper">
            ...
            <div class="inner-sidebar">
                ...
                <div class="inner-sidebar-header justify-content-center">
                    ...
                    <?php else: ?>
                        <!-- Optionally, show a message or hide the button if not logged in -->
                        <p>Please log in to create a new discussion.</p>
                    <?php endif; ?>
                </div>
...
<script>$(document).ready(function () {
        ...
        $('#postButton').click(function () {
            ...
            $.ajax({
                url: 'create_thread.php',  // PHP script to handle the form data
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
                success: function (response) {
                    if (response.success) {
                        ...
                        // Optionally reload the page or update the forum list
                    } else {
