<!-- FOOTER -->
<footer class="py-5 bg-black" style="margin-top: 250px;">
  <!-- Footer content here -->
  ...
  <div class="container">
    ...
    <div class="row">
      <a style="   font-family: Bungee Shade, sans-serif;" class="py-0 my-0 fs-2 nav-link active text-center text-light"
        aria-current="page" href="#">CareerLink</a>
    </div>
