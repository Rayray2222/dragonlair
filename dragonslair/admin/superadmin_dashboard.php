            ...
            <div class="col-md-3 mb-3">
                <div class="card text-bg-primary text-center h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="super_departments.php" class="btn btn-outline-light btn-block"><svg
            ...
            <div class="col-md-3 mb-3">
                <div class="card text-bg-primary text-center h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="super_recruiters.php" class="btn btn-outline-light"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <div class="col-md-3 mb-3">
                <div class="card text-bg-primary text-center h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="super_applicants.php" class="btn btn-outline-light"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <div class="col-md-3 mb-3">
                <div class="card text-bg-primary text-center h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="super_job_offers.php" class="btn btn-outline-light btn-block"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
