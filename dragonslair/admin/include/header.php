    ...
    <div class="hide_menu">
      <div class="btn-toolbar mb-2 mb-md-0 me-2 ">
        ...
        <ul class="dropdown-menu dropdown-menu-end" style="">
          <li><a class="dropdown-item" href="rec_dashboard.php"><svg xmlns="http://www.w3.org/2000/svg" width="20"
                height="20" fill="currentColor" class="bi bi-stack" viewBox="0 0 16 16">
                <path
          ...
          <li><a class="dropdown-item" href="../rec_home.php"><svg xmlns="http://www.w3.org/2000/svg" width="20"
