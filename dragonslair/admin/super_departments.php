...
include('include/superheader.php');
include('include/supersidebar.php');
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-4 pb-2 mb-1">
  ...
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-1 pb-2 mb-1 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0 gap-2">
      <a href="admin_add.php" type="button" class="btn btn-primary btn-sm"><svg xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="admin_restore.php" type="button" class="btn btn-outline-primary btn-sm"><svg
          xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-database-fill-down"
          viewBox="0 0 16 16">
          <path
          ...
          while ($row = mysqli_fetch_array($query)) {
            ...
            <tr>
              ...
              <td>
                <div class="row">
                  <div class="btn-group">
                    <a href="admin_edit.php?edit=<?php echo $row['id']; ?>" class="btn btn-success"><span
                        class="bi bi-pencil-fill"></span></a>

                    <a href="phpcode/admin_fake_delete.php?del=<?php echo $row['id']; ?>" class="btn btn-danger"><span
                        class="bi bi-trash-fill"></span></a>
