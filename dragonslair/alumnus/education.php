    ...
    <div class="daform2">
        ...
        <div class="card scroll4 border-yellow shadow-lg">
            <h5 class="card-header border-yellow text-center fs-2 bg-yellow"
                style=" font-weight: bold; font-family: Passion One, sans-serif;">Your Educations</h5>
            <div class="card-body">
                <div class="">
                    <div class="row g-3">
                        <?php
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <div class="card scroll4 border-green shadow-lg">
                                        <h5 class="card-header text-center fs-2">
                                            <?php echo strtoupper($row['degree']); ?>
                                        </h5>
                                        <div class="card-body">
                                            <div class="row g-3">
                                                <div class="col-sm-6">
                ...
                <hr class="my-4">
                <a type="submit" href="education_add.php" class="w-100 fs-3 btn btn-blue hover3"
                    style=" font-weight: bold; font-family: Passion One, sans-serif;">Add Education</a>
                ...
                <div class="col-12 text-center mt-2">
                    <form action="delete_education.php" method="POST"
                        ...
                        <input type="submit" class="btn btn-danger w-100 fs-3 btn btn-blue hover3"
                            style=" font-weight: bold; font-family: Passion One, sans-serif;" value="Delete">
                    </form>
                </div>
            </div>
        </div>
