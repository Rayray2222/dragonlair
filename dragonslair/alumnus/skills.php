    ...
    <div class="daform2">
        ...
        <div class="card scroll4 border-yellow shadow-lg">
            <h5 class="card-header border-yellow text-center fs-2 bg-yellow"
                style=" font-weight: bold; font-family: Passion One, sans-serif;">Your Skills</h5>
            <div class="card-body">
                <div class="">
                    <div class="row g-3">
                        <?php
                ...
                <hr class="my-4">
                <a type="submit" href="skills_add.php" class="w-100 fs-3 btn btn-blue hover3"
                    style=" font-weight: bold; font-family: Passion One, sans-serif;">Add Skill</a>
            </div>
        </div>
