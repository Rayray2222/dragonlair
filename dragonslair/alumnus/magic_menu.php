    ...
    <div class="navigation daformm">
        <ul class="">
            ...
            <li class="list ">
                <a href="cv.php">
                    <span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                            fill="currentColor" class="bi bi-file-earmark-check-fill" viewBox="0 0 16 16">
                            <path
            ...
            <li class="list">
                <a href="forums.php"> <!-- New Link for "Make Threads" -->
                    <span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                            fill="currentColor" class="bi bi-chat-left-dots-fill" viewBox="0 0 16 16">
                            <path
                                d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
                        </svg></span>
                    <span class="text">Post a thread</span> <!-- Text for the new option -->
                </a>
            </li>

            <li class="list">
                <a href="phpcode/logout.php">
                    <span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
