...
<head>
  ...
  <title>Hawk - Free Bootstrap 5 One Page Template</title>
  <meta name="description" content="Hawk is a Free Bootstrap 5 One Page Template.">
  ...
  <!-- CSS Files -->
  <link rel="stylesheet" href="./assets/css/hawk-bsb.css">
...
<body data-bs-spy="scroll" data-bs-target="#bsb-tpl-navbar" data-bs-smooth-scroll="true" tabindex="0">
  ...
  <header id="header">
    ...
    <section id="scrollspyHero" class="bsb-hero-5 px-3 bsb-overlay"
      style="background-image: url('./assets/img/hero/hero-img-1.webp');">
      <div class="container">
        <div class="row justify-content-md-center align-items-center">
          <div class="col-12 col-md-11 col-lg-9 col-xl-8 col-xxl-7">
            ...
            <p class="lead text-white text-center mb-5 d-flex justify-content-sm-center">
              <span class="col-12 col-sm-10 col-md-8 col-xxl-7">There are three ways to ultimate success: The first way
                is to be kind. The second way is to be kind. The third way is to be kind.</span>
            </p>
  ...
  <main id="main">
    ...
    <section id="scrollspyAbout" class="py-3 py-md-5 py-xl-8 pb-xxl-0 bsb-section-pt-xxl-1">
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-10 col-lg-8">
            <h3 class="fs-5 mb-2 text-secondary text-uppercase">About</h3>
            <h2 class="display-5 fw-bold mb-4">Our journey began with a dream of redefining how the world perceives
              design.</h2>
      ...
      <div class="container overflow-hidden">
        <div class="row gy-4 gy-lg-0">
          <div class="col-12 col-lg-6">
            <article>
              <div class="card border-0">
                <img class="card-img-top img-fluid m-0" loading="lazy" src="./assets/img/about/about-img-1.jpg" alt="">
                <div class="card-body border bg-white p-4">
                  ...
                  <p class="card-text entry-summary text-secondary mb-3">From sleek modernism to timeless elegance, we
                    infuse every creation with a touch of our artistic ingenuity. As a design agency, great design can
                    shape perceptions, and leave an indelible mark on the world.</p>
                </div>
              </div>
            </article>
          </div>
          <div class="col-12 col-lg-6">
            <article>
              <div class="card border-0">
                <img class="card-img-top img-fluid m-0" loading="lazy" src="./assets/img/about/about-img-2.jpg" alt="">
                <div class="card-body border bg-white p-4">
                  <div class="entry-header mb-3">
                    <h2 class="card-title entry-title h4 mb-0">
                  ...
                  <p class="card-text entry-summary text-secondary mb-3">Welcome to our design agency, where creativity
                    knows no bounds and innovation takes center stage. We are a team of designers with a passion for
                    transforming ideas into captivating visuals.</p>
                </div>
              </div>
            </article>
          </div>
    ...
    <section class="bsb-cta-3 py-3 py-md-5 py-xl-8 pb-xxl-0 bsb-section-pt-xxl-1">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="container-fluid bg-accent border shadow">
              <div class="row">
                <div class="col-12 col-md-6 p-0">
                  <div class="card border-0 bg-transparent">
                    <div class="card-body text-center p-5 p-xl-8">
                      <h4 class="fw-bold mb-4">Innovative Design Strategies</h4>
                      <p class="mb-4 mb-xl-5 text-secondary">Innovation drives our designs as we constantly explore
                        emerging technologies to deliver cutting-edge experiences. We believe in putting the user at the
                        center of our design process.</p>
                ...
                <div class="col-12 col-md-6 p-0 border-top border-bottom border-start">
                  <div class="card border-0 bg-transparent">
                    <div class="card-body text-center p-5 p-xl-8">
                      ...
                      <p class="mb-4 mb-xl-5 text-secondary">Our marketing strategies are a testament to
                        customer-centricity. By leveraging data-driven insights, we create impactful campaigns that
                        resonate with today's discerning audiences.</p>
                      <a href="#!" class="fw-bold text-decoration-none link-primary">
                        Learn More
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                          class="bi bi-arrow-right-short" viewBox="0 0 16 16">
    ...
    <section id="scrollspyPortfolio" class="py-3 py-md-5 py-xl-8 pb-xxl-0 bsb-section-pt-xxl-1">
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-10 col-lg-8">
            <h3 class="fs-5 mb-2 text-secondary text-uppercase">Portfolio</h3>
            <h2 class="display-5 fw-bold mb-4">From captivating websites to breathtaking visual identities, our
              portfolio is a testament to our dedication.</h2>
        ...
        <div class="row gy-3 gy-lg-4 gy-lg-0x">
            ...
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale-up bsb-hover-scale" loading="lazy"
                  src="./assets/img/project/project-image-1.jpg" alt="">
              </a>
              <figcaption>
            ...
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy"
                  src="./assets/img/project/project-image-2.jpg" alt="">
              </a>
              <figcaption>
          ...
          <div class="col-12 col-lg-6">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale-up bsb-hover-scale" loading="lazy"
                  src="./assets/img/project/project-image-3.jpg" alt="">
              </a>
              <figcaption>
          ...
          <div class="col-12 col-lg-6">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy"
                  src="./assets/img/project/project-image-4.jpg" alt="">
              </a>
              <figcaption>
    ...
    <section id="scrollspyServices" class="bsb-service-7 py-3 py-md-5 py-xl-8 pb-xxl-0 bsb-section-pt-xxl-1">
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-8 col-xl-7">
            <h3 class="fs-5 mb-2 text-secondary text-center text-uppercase">Services</h3>
            <h2 class="display-5 fw-bold mb-5 mb-xl-9 text-center">We offer premier services where excellence meets
              affordability.</h2>
          </div>
        </div>
      </div>
              ...
              <div class="row">
                  ...
                  <div class="card border-0 bg-transparent">
                    <div class="card-body text-center p-5">
                      <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor"
                        class="bi bi-basket2-fill text-primary mb-4" viewBox="0 0 16 16">
                        <path
                      ...
                      <p class="mb-4 text-secondary">The first phase is to develop a strategy for the product or service
                        that the tech company is developing. This involves understanding the market needs.</p>
                      <a href="#!" class="fw-bold text-decoration-none link-primary">
                        Learn More
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                          class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                ...
                <div class="col-12 col-md-4 p-0 border-top border-bottom border-start border-end">
                  <div class="card border-0 bg-transparent">
                    <div class="card-body text-center p-5">
                      <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor"
                        class="bi bi-rocket text-primary mb-4" viewBox="0 0 16 16">
                      ...
                      <p class="mb-4 text-secondary">Once the strategy is in place, the next phase is to design the
                        product or service. This involves creating wireframes, prototypes, and mockups.</p>
                      <a href="#!" class="fw-bold text-decoration-none link-primary">
                        Learn More
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                          class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                ...
                <div class="col-12 col-md-4 p-0">
                  <div class="card border-0 bg-transparent">
                    <div class="card-body text-center p-5">
                      <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor"
                        class="bi bi-incognito text-primary mb-4" viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                      ...
                      <p class="mb-4 text-secondary">Once the design is finalized, the next phase is to develop the
                        product or service. This involves writing code, building databases, and creating assets.</p>
                      <a href="#!" class="fw-bold text-decoration-none link-primary">
                        Learn More
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                          class="bi bi-arrow-right-short" viewBox="0 0 16 16">
    ...
    <section class="py-3 py-md-5 py-xl-8 pb-xxl-0 bsb-section-pt-xxl-1">
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-10 col-lg-8">
            <h3 class="fs-5 mb-2 text-secondary text-uppercase">Testimonials</h3>
            <h2 class="display-5 fw-bold mb-4">Our valued clients' testimonials speak volumes about our work's power.
            </h2>
        ...
        <div class="row gy-3 gy-lg-4">
          <div class="col-12 col-lg-6">
            <div class="card">
              <div class="card-body p-4 p-xxl-5">
                ...
                <blockquote class="bsb-blockquote-icon mb-3">We were so impressed with the work they did for us. They
                  were able to take our vision and turn it into a reality, and they did it all on time and within
                  budget. We would highly recommend them to anyone looking for a reliable and professional partner.
                </blockquote>
                <figure class="d-flex align-items-center m-0 p-0">
                  <img class="img-fluid rounded rounded-circle m-0 border border-5" loading="lazy"
          ...
          <div class="col-12 col-lg-6">
            <div class="card">
              <div class="card-body p-4 p-xxl-5">
                ...
                <blockquote class="bsb-blockquote-icon mb-3">We were looking for a company that could help us develop a
                  new website that was both visually appealing and user-friendly. We are so happy with the results, and
                  we would highly recommend them to anyone looking for a new website.</blockquote>
                <figure class="d-flex align-items-center m-0 p-0">
                  <img class="img-fluid rounded rounded-circle m-0 border border-5" loading="lazy"
          ...
          <div class="col-12 col-lg-6">
            <div class="card">
              <div class="card-body p-4 p-xxl-5">
                ...
                <blockquote class="bsb-blockquote-icon mb-3">We were struggling to manage our finances effectively. We
                  needed help developing a financial plan. They create a financial plan that worked for us, and they
                  showed us how to track our spending more effectively. We are so grateful for the help.</blockquote>
                <figure class="d-flex align-items-center m-0 p-0">
                  <img class="img-fluid rounded rounded-circle m-0 border border-5" loading="lazy"
                    src="./assets/img/testimonial/testimonial-img-3.jpg" alt="Michael Wilson">
                  <figcaption class="ms-3">
          ...
          <div class="col-12 col-lg-6">
            <div class="card">
              <div class="card-body p-4 p-xxl-5">
                <div class="bsb-ratings text-warning mb-3" data-bsb-star="5" data-bsb-star-off="0"></div>
                <blockquote class="bsb-blockquote-icon mb-3">We were looking for a company that could help us with our
                  branding. We needed a website and marketing materials. They were able to create a brand identity that
                  we loved. They worked with us to develop a logo that represented our company.</blockquote>
                <figure class="d-flex align-items-center m-0 p-0">
                  <img class="img-fluid rounded rounded-circle m-0 border border-5" loading="lazy"
      ...
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-8 col-xl-7">
            ...
            <h2 class="display-5 fw-bold mb-5 mb-xl-9 text-center">We have a proven track record of success.</h2>
          </div>
        </div>
      </div>
    ...
    <section id="scrollspyBlog" class="py-3 py-md-5 py-xl-8 pb-xxl-0 bsb-section-pt-xxl-1">
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-10 col-lg-8">
            <h3 class="fs-5 mb-2 text-secondary text-uppercase">Blog</h3>
            <h2 class="display-5 fw-bold mb-4">Here is our blog's latest company news about regularly publishing fresh
              content.</h2>
            ...
            <article>
              <div class="card border-0">
                <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
                  <a href="#!">
                    <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy"
                      src="./assets/img/blog/blog-image-1.jpg" alt="Business">
                  </a>
                  <figcaption>
                ...
                <div class="card-body border bg-white p-4">
                  ...
                  <p class="card-text entry-summary text-secondary mb-3">
                    Buying an existing business can be an exciting experience for entrepreneurs. Before you decide
                    whether to pursue this endeavor, it's essential to understand the process of purchasing a business.
                  </p>
            ...
            <article>
              <div class="card border-0">
                <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
                  <a href="#!">
                    <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy"
                      src="./assets/img/blog/blog-image-2.jpg" alt="Living">
                  </a>
                  <figcaption>
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                ...
                <div class="card-body border bg-white p-4">
                  ...
                  <p class="card-text entry-summary text-secondary mb-3">
                    Learn how a marketing coach earned six figures by 20, primarily through 1:1 sales. Her insights
                    provide valuable guidance for other entrepreneurs seeking to connect with their audience
                    effectively.
                  </p>
                  <a href="#!" class="btn btn-primary m-0 text-nowrap entry-more">Read More</a>
                </div>
    ...
    <section id="scrollspyPricing" class="bsb-pricing-3 py-3 py-md-5 py-xl-8 pb-xxl-0 bsb-section-pt-xxl-1">
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-8 col-xl-7">
            <h3 class="fs-5 mb-2 text-secondary text-center text-uppercase">Our Pricing</h3>
            <h2 class="display-5 fw-bold mb-5 mb-xl-9 text-center">We offer simple, reasonable, and diaphanous pricing
              plans.</h2>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="container-fluid bg-accent border pb-4 mt-md-6 shadow">
              <div class="row">
                ...
                <div class="col-12 col-md-4">
                  <div class="card bg-white border-0 border-top pt-md-6 shadow-sm bsb-pricing-popular">
                    <div class="card-body position-relative p-4 p-xxl-5">
                      <span class="badge text-bg-warning position-absolute top-0 start-50 translate-middle">Most
                        Popular</span>
    ...
    <section id="scrollspyContact" class="py-3 py-md-5 py-xl-8 pb-xxl-0 bsb-section-pt-xxl-1">
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-10 col-lg-8">
            <h3 class="fs-5 mb-2 text-secondary text-uppercase">Contact</h3>
            <h2 class="display-5 fw-bold mb-4 mb-md-5 mb-xl-8">We're always on the lookout to work with new clients.
      ...
      <div class="container">
        <div class="row gy-4 gy-md-5 gy-lg-0 align-items-md-center">
          <div class="col-12 col-lg-6">
            <div class="bg-accent shadow border overflow-hidden">
              ...
              <div class="col-12 col-xl-11">
                <div class="mb-4 mb-md-5">
                  ...
                  <div>
                    ...
                    <address class="m-0 text-secondary">8014 Edith Blvd NE, Albuquerque, New York, United States
                    </address>
                  </div>
                </div>
    ...
    <section class="bsb-skill-2 py-3 py-md-5 py-xl-8 pb-xxl-0 bsb-section-pt-xxl-1">
      <div class="container overflow-hidden">
        <div class="row gy-3 gy-lg-4">
          <div class="col-12 col-lg-6">
            <div class="card">
              <div class="card-body p-4 p-xxl-5">
                <div class="row align-items-center">
                  <div class="col-12 col-md-7 skill-title">
                    ...
                    <p class="text-secondary fst-italic mb-4 mb-md-0">Bootstrap is a front-end framework that makes it
                      easy to create responsive and mobile-friendly websites.</p>
                  </div>
                  <div class="col-12 col-md-5 skill-progress">
                    <div class="progress">
                      <div class="progress-bar progress-bar-striped progress-bar-animated progress-bar-width-1"
                        role="progressbar" aria-label="Bootstrap" aria-valuenow="85" aria-valuemin="0"
              ...
              <div class="card-body p-4 p-xxl-5">
                <div class="row align-items-center">
                  <div class="col-12 col-md-7 skill-title">
                    ...
                    <p class="text-secondary fst-italic mb-4 mb-md-0">React is a JavaScript library for building user
                      interfaces. It is known for its speed, performance, and scalability.</p>
                  </div>
                  <div class="col-12 col-md-5 skill-progress">
                    <div class="progress">
                      <div class="progress-bar progress-bar-striped progress-bar-animated progress-bar-width-2"
                        role="progressbar" aria-label="React" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                        75%</div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-body p-4 p-xxl-5">
                <div class="row align-items-center">
                  <div class="col-12 col-md-7 skill-title">
                    ...
                    <p class="text-secondary fst-italic mb-4 mb-md-0">Vue is a JavaScript framework for building user
                      interfaces. It is known for its simplicity and flexibility.</p>
                  </div>
                  <div class="col-12 col-md-5 skill-progress">
                    <div class="progress">
                      <div class="progress-bar progress-bar-striped progress-bar-animated progress-bar-width-3"
                        role="progressbar" aria-label="Vue" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">65%
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-body p-4 p-xxl-5">
                <div class="row align-items-center">
                  <div class="col-12 col-md-7 skill-title">
                    ...
                    <p class="text-secondary fst-italic mb-4 mb-md-0">WordPress is a content management system (CMS)
                      that is used to create and manage websites.</p>
                  </div>
                  <div class="col-12 col-md-5 skill-progress">
                    <div class="progress">
                      <div class="progress-bar progress-bar-striped progress-bar-animated progress-bar-width-4"
                        role="progressbar" aria-label="WordPress" aria-valuenow="95" aria-valuemin="0"
  ...
  <footer class="footer py-3 py-md-5 py-xl-8 bsb-section-py-xxl-1">
    <div class="container">
      <div class="container-fluid bg-accent">
        <div class="row justify-content-center">
          <div class="col-12 col-md-11">
              ...
              <div class="container-fluid overflow-hidden">
                <div class="row gy-4 gy-lg-0 justify-content-xl-between">
                  <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                    <div class="widget">
                      <a href="#!">
                        <img src="./assets/img/branding/hawk-logo-dark.svg" alt="" class="bsb-tpl-logo-footer">
                      </a>
                    </div>
                  </div>
                  <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                    <div class="widget">
                      ...
                      <ul class="list-unstyled">
                        <li class="mb-2">
                          <a href="#!" class="link-dark text-decoration-none">AI Solutions</a>
                        </li>
                        <li class="mb-2">
                          <a href="#!" class="link-dark text-decoration-none">Digital Marketing</a>
                        </li>
                        <li class="mb-2">
                          <a href="#!" class="link-dark text-decoration-none">App Development</a>
                        </li>
                        <li class="mb-2">
                          <a href="#!" class="link-dark text-decoration-none">SEO Consultancy</a>
                        </li>
                        <li class="mb-0">
                          <a href="#!" class="link-dark text-decoration-none">Web Design</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                    <div class="widget">
                      ...
                      <ul class="list-unstyled">
                        <li class="mb-2">
                          <a href="#!" class="link-dark text-decoration-none">About</a>
                        </li>
                        <li class="mb-2">
                          <a href="#!" class="link-dark text-decoration-none">Contact</a>
                        </li>
                        <li class="mb-2">
                          <a href="#!" class="link-dark text-decoration-none">Advertise</a>
                        </li>
                        <li class="mb-2">
                          <a href="#!" class="link-dark text-decoration-none">Terms of Service</a>
                        </li>
                        <li class="mb-0">
            ...
            <div class="py-4 py-md-5 py-xl-8 border-top border-accent-subtle">
              <div class="container-fluid overflow-hidden">
  ...
  <script src="./assets/controller/hawk-bsb.js"></script>
