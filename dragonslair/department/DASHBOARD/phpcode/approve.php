...
if (isset($_GET['id'])) {	/* putting the values typed by super admin into post GV */
    ...
    try {
        ...
        $query = "UPDATE `applied_jobs` SET `statut` = 'Approved' WHERE `applied_jobs`.`app_id` = '$app_id'; ";
        ...
        if ($s) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $msg = "Congratulations you successfully approved";
            ...
            $_SESSION['statut'] = "Approved successfuly";
            //echo "insertion successful";
            header('location: ../my_job.php');
            exit();
        } else {
            $_SESSION['statut'] = "Unsuccessful";
        }
