...
if (isset($_POST['submit'])) {
  ...
  if ($rec_id !== '' && $email !== '' && $username !== '' && $rec_fname !== '' && $rec_lname !== '' && $password !== '' && $companyname !== '' && $industry !== '' && $website !== '' && $description !== '' && $phone !== '' && $address !== '' && $city !== '' && $country !== '' && $zip !== '' && $foundation !== '') {
    ...
    if ($query) {
      ...
      $_SESSION['idd'] = $rec_id;
      header('location: ../DASHBOARD/edit_recruiter.php');
      exit();
    } else {
